...
## treat 是treat
## Mediator 是job_seek
## Outcome 是depress2, huanliu's paper
## Covariates：econ_hard,educ,sex,income,nonwhite,comply,work1,marital,

```{r}
data = rio::import("/Users/xli36/Downloads/R_packages/myproject/jobs_v2.csv")
colnames(data)
...
```{r}
matchit(treat~econ_hard+depress1+sex+age+occp+marital+nonwite+educ+job_seek+depress2+work1+comply+control+job_dich+job_disc)
```
