...
f_exp1 <- function(seed){
  ...
  save_path = paste0("/Users/xli36/Downloads/R_packages/myproject/expe1_new/seed_xgb_",seed,".rds")
...
my_new_folder = "/Users/xli36/Downloads/R_packages/myproject/expe1_new"
